...
const _: () = {
    ...
    use ink_metadata::layout::{CellLayout, HashLayout, HashingStrategy, Layout, LayoutKey};
        ...
        Key: From<<H as HashOutput>::Type>,
    {
        fn layout(key_ptr: &mut KeyPtr) -> Layout {
            Layout::Hash(HashLayout::new(
                ...
                Layout::Cell(CellLayout::new::<V>(LayoutKey::from(key_ptr.advance_by(0)))),
            ))
        }
    }
};
            ...
            BTreeMapEntry::Vacant(entry) => {
                ...
                match value.is_some() {
                    true => {
                        ...
                        // to reflect this.
                        let v_mut =
                            entry.insert(Box::new(StorageEntry::new(value, EntryState::Preserved)));
                        Entry::Occupied(OccupiedEntry {
                            key,
                            entry: EntryOrMutableValue::MutableValueElementWasNotInCache(v_mut),
                        })
                    }
