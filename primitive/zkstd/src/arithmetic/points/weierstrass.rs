...
use crate::common::{CurveGroup, PrimeField, WeierstrassCurve, WeierstrassProjective};

/// weierstrass affine coordinate addition
#[inline(always)]
pub fn add_affine_point<P: WeierstrassProjective>(lhs: P, rhs: P) -> P {
...
#[inline(always)]
pub fn double_affine_point<P: WeierstrassProjective>(point: P) -> P {
