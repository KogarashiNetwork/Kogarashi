...
fn main() -> Result<(), Error> {
        ...
        P: TEModelParameters<BaseField = F>,
    {
        ...
        fn gadget(&mut self, composer: &mut StandardComposer<F, P>) -> Result<(), Error> {
            ...
            let g_pow_randomness = composer.fixed_base_scalar_mul(randomness, self.generator);
            composer.assert_equal_public_point(
                g_pow_randomness,
            ...
            let g_pow_after_balance =
                composer.fixed_base_scalar_mul(alice_after_balance, self.generator);
            ...
            let calculated_pk = composer.fixed_base_scalar_mul(alice_private_key, self.generator);
    ...
    let alice_private_key = BlsScalar::from(BigInteger256::new([
        0xc4676aa0f64d1a88,
        0x16699cf541a046f2,
        0x11325506c9fb4ad9,
        0xff84cc3fcc5453b,
    ...
    let bob_private_key = BlsScalar::from(BigInteger256::new([
        0x1278bc1c0481ffe7,
        0xdf2df249cebbda4c,
        0x23aee7c515fd95c1,
        0x129cf38261170bf7,
    ...
    let randomness = BlsScalar::from(123);
