...
fn main() -> Result<(), Error> {
        ...
        P: TEModelParameters<BaseField = F>,
    {
        ...
        fn gadget(&mut self, composer: &mut StandardComposer<F, P>) -> Result<(), Error> {
            ...
            let alice_public_key = composer.add_affine(self.alice_public_key);
            let bob_public_key = composer.add_affine(self.bob_public_key);
            let alice_left_encrypted_balance =
                composer.add_affine(self.alice_left_encrypted_balance);
            let alice_right_encrypted_balance =
                composer.add_affine(self.alice_right_encrypted_balance);
            let alice_left_encrypted_transfer_amount =
                composer.add_affine(self.alice_left_encrypted_transfer_amount);
            let alice_right_encrypted_transfer_amount =
                composer.add_affine(self.alice_right_encrypted_transfer_amount);
            ...
            let alice_pk_powered_by_randomness =
                composer.variable_base_scalar_mul(randomness, alice_public_key);
            ...
            let bob_pk_powered_by_randomness =
                composer.variable_base_scalar_mul(randomness, bob_public_key);
